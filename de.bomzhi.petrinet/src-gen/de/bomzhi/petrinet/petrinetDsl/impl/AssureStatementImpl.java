...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Assure Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.AssureStatementImpl#getCount <em>Count</em>}</li>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.AssureStatementImpl#getResourceRef <em>Resource Ref</em>}</li>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.AssureStatementImpl#getPlaceRef <em>Place Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AssureStatementImpl extends MinimalEObjectImpl.Container implements AssureStatement
{
  /**
  ...
  {
    return PetrinetDslPackage.Literals.ASSURE_STATEMENT;
  }
  ...
  public void setCount(int newCount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.ASSURE_STATEMENT__COUNT, oldCount, count));
  }
  ...
  public Resource getResourceRef()
  {
    if (resourceRef != null && resourceRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetDslPackage.ASSURE_STATEMENT__RESOURCE_REF, oldResourceRef, resourceRef));
      }
    }
    return resourceRef;
  }
  ...
  public void setResourceRef(Resource newResourceRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.ASSURE_STATEMENT__RESOURCE_REF, oldResourceRef, resourceRef));
  }
  ...
  public Place getPlaceRef()
  {
    if (placeRef != null && placeRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetDslPackage.ASSURE_STATEMENT__PLACE_REF, oldPlaceRef, placeRef));
      }
    }
    return placeRef;
  }
  ...
  public void setPlaceRef(Place newPlaceRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.ASSURE_STATEMENT__PLACE_REF, oldPlaceRef, placeRef));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PetrinetDslPackage.ASSURE_STATEMENT__COUNT:
        return getCount();
      case PetrinetDslPackage.ASSURE_STATEMENT__RESOURCE_REF:
        if (resolve) return getResourceRef();
        return basicGetResourceRef();
      case PetrinetDslPackage.ASSURE_STATEMENT__PLACE_REF:
