 ...
 * <ul>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.PlaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.PlaceImpl#getStorages <em>Storages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends MinimalEObjectImpl.Container implements Place
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.PLACE__NAME, oldName, name));
  }
  ...
  public EList<Storage> getStorages()
  {
    if (storages == null)
    {
      storages = new EObjectContainmentEList<Storage>(Storage.class, this, PetrinetDslPackage.PLACE__STORAGES);
    }
    return storages;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PetrinetDslPackage.PLACE__STORAGES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PetrinetDslPackage.PLACE__NAME:
        return getName();
      case PetrinetDslPackage.PLACE__STORAGES:
        return getStorages();
    }
