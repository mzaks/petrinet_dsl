...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Take Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.TakeStatementImpl#getCount <em>Count</em>}</li>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.TakeStatementImpl#getResourceRef <em>Resource Ref</em>}</li>
 *   <li>{@link de.bomzhi.petrinet.petrinetDsl.impl.TakeStatementImpl#getPlaceRef <em>Place Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TakeStatementImpl extends MinimalEObjectImpl.Container implements TakeStatement
{
  /**
  ...
  {
    return PetrinetDslPackage.Literals.TAKE_STATEMENT;
  }
  ...
  public void setCount(int newCount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.TAKE_STATEMENT__COUNT, oldCount, count));
  }
  ...
  public Resource getResourceRef()
  {
    if (resourceRef != null && resourceRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetDslPackage.TAKE_STATEMENT__RESOURCE_REF, oldResourceRef, resourceRef));
      }
    }
    return resourceRef;
  }
  ...
  public void setResourceRef(Resource newResourceRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.TAKE_STATEMENT__RESOURCE_REF, oldResourceRef, resourceRef));
  }
  ...
  public Place getPlaceRef()
  {
    if (placeRef != null && placeRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetDslPackage.TAKE_STATEMENT__PLACE_REF, oldPlaceRef, placeRef));
      }
    }
    return placeRef;
  }
  ...
  public void setPlaceRef(Place newPlaceRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PetrinetDslPackage.TAKE_STATEMENT__PLACE_REF, oldPlaceRef, placeRef));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PetrinetDslPackage.TAKE_STATEMENT__COUNT:
        return getCount();
      case PetrinetDslPackage.TAKE_STATEMENT__RESOURCE_REF:
        if (resolve) return getResourceRef();
        return basicGetResourceRef();
      case PetrinetDslPackage.TAKE_STATEMENT__PLACE_REF:
